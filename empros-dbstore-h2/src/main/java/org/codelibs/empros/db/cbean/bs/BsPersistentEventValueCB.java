 ...
 */
public class BsPersistentEventValueCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected PersistentEventValueCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsPersistentEventValueCB() {
    ...
    public static class HpSpecification extends
        ...
        protected void doSpecifyRequiredColumn() {
            columnId(); // PK
            if (qyCall().qy().hasConditionQueryPersistentEvent()
                    || qyCall().qy().xgetReferrerQuery() instanceof PersistentEventCQ) {
