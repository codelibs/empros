 ...
 */
public abstract class AbstractBsPersistentEventCQ extends
        AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsPersistentEventCQ(final ConditionQuery childQuery,
     ...
     * PERSISTENT_EVENT_VALUE by your EVENT_ID, named 'persistentEventValueAsOne'.
     * <pre>
     * cb.query().<span style="color: #FD4747">existsPersistentEventValueList</span>(new SubQuery&lt;PersistentEventValueCB&gt;() {
     *     public void query(PersistentEventCB subCB) {
     *         subCB.query().setXxx...
     *     }
     * });
     * </pre>
     * @param subQuery The sub-query of PersistentEventValueList for 'exists'. (NotNull)
     */
    public void existsPersistentEventValueList(
        ...
        subQuery.query(cb);
        final String subQueryPropertyName = keepId_ExistsReferrer_PersistentEventValueList(cb
                .query()); // for saving query-value.
        registerExistsReferrer(cb.query(), "ID", "EVENT_ID",
                subQueryPropertyName, "persistentEventValueList");
    }

    public abstract String keepId_ExistsReferrer_PersistentEventValueList(
     ...
     * PERSISTENT_EVENT_VALUE by your EVENT_ID, named 'persistentEventValueAsOne'.
     * <pre>
     * cb.query().<span style="color: #FD4747">notExistsPersistentEventValueList</span>(new SubQuery&lt;PersistentEventValueCB&gt;() {
     *     public void query(PersistentEventCB subCB) {
     *         subCB.query().setXxx...
     *     }
     * });
     * </pre>
     * @param subQuery The sub-query of Id_NotExistsReferrer_PersistentEventValueList for 'not exists'. (NotNull)
     */
    public void notExistsPersistentEventValueList(
            final SubQuery<PersistentEventValueCB> subQuery) {
        assertObjectNotNull("subQuery<PersistentEventValueCB>", subQuery);
        final PersistentEventValueCB cb = new PersistentEventValueCB();
        cb.xsetupForExistsReferrer(this);
        subQuery.query(cb);
        final String subQueryPropertyName = keepId_NotExistsReferrer_PersistentEventValueList(cb
                .query()); // for saving query-value.
        registerNotExistsReferrer(cb.query(), "ID", "EVENT_ID",
                subQueryPropertyName, "persistentEventValueList");
    }

    public abstract String keepId_NotExistsReferrer_PersistentEventValueList(
            PersistentEventValueCQ subQuery);

    /**
     * Set up InScopeRelation (sub-query). <br />
     * {in (select EVENT_ID from PERSISTENT_EVENT_VALUE where ...)} <br />
     * PERSISTENT_EVENT_VALUE by your EVENT_ID, named 'persistentEventValueAsOne'.
     * @param subQuery The sub-query of PersistentEventValueList for 'in-scope'. (NotNull)
     */
    public void inScopePersistentEventValueList(
            final SubQuery<PersistentEventValueCB> subQuery) {
        assertObjectNotNull("subQuery<PersistentEventValueCB>", subQuery);
        final PersistentEventValueCB cb = new PersistentEventValueCB();
        cb.xsetupForInScopeRelation(this);
        subQuery.query(cb);
        final String subQueryPropertyName = keepId_InScopeRelation_PersistentEventValueList(cb
                .query()); // for saving query-value.
        registerInScopeRelation(cb.query(), "ID", "EVENT_ID",
                subQueryPropertyName, "persistentEventValueList");
    }

    public abstract String keepId_InScopeRelation_PersistentEventValueList(
            PersistentEventValueCQ subQuery);

    /**
     * Set up NotInScopeRelation (sub-query). <br />
     * {not in (select EVENT_ID from PERSISTENT_EVENT_VALUE where ...)} <br />
     * PERSISTENT_EVENT_VALUE by your EVENT_ID, named 'persistentEventValueAsOne'.
     * @param subQuery The sub-query of PersistentEventValueList for 'not in-scope'. (NotNull)
     */
    public void notInScopePersistentEventValueList(
            final SubQuery<PersistentEventValueCB> subQuery) {
        assertObjectNotNull("subQuery<PersistentEventValueCB>", subQuery);
        final PersistentEventValueCB cb = new PersistentEventValueCB();
        cb.xsetupForInScopeRelation(this);
        subQuery.query(cb);
        final String subQueryPropertyName = keepId_NotInScopeRelation_PersistentEventValueList(cb
                .query()); // for saving query-value.
        registerNotInScopeRelation(cb.query(), "ID", "EVENT_ID",
                subQueryPropertyName, "persistentEventValueList");
    }

    public abstract String keepId_NotInScopeRelation_PersistentEventValueList(
            PersistentEventValueCQ subQuery);

    public void xsderivePersistentEventValueList(final String function,
            final SubQuery<PersistentEventValueCB> subQuery,
        ...
        subQuery.query(cb);
        final String subQueryPropertyName = keepId_SpecifyDerivedReferrer_PersistentEventValueList(cb
                .query()); // for saving query-value.
        registerSpecifyDerivedReferrer(function, cb.query(), "ID", "EVENT_ID",
                subQueryPropertyName, "persistentEventValueList", aliasName,
                option);
    }

    public abstract String keepId_SpecifyDerivedReferrer_PersistentEventValueList(
            PersistentEventValueCQ subQuery);
     ...
     */
    public HpQDRFunction<PersistentEventValueCB> derivedPersistentEventValueList() {
        ...
        return new HpQDRFunction<PersistentEventValueCB>(
                new HpQDRSetupper<PersistentEventValueCB>() {
                    ...
                    public void setup(final String function,
                        ...
                        xqderivePersistentEventValueList(function, subQuery,
                                operand, value, option);
                    }
                });
    }

    public void xqderivePersistentEventValueList(final String function,
            final SubQuery<PersistentEventValueCB> subQuery,
            final String operand, final Object value,
            final DerivedReferrerOption option) {
        assertObjectNotNull("subQuery<PersistentEventValueCB>", subQuery);
        ...
        cb.xsetupForDerivedReferrer(this);
        subQuery.query(cb);
        final String subQueryPropertyName = keepId_QueryDerivedReferrer_PersistentEventValueList(cb
                .query()); // for saving query-value.
        final String parameterPropertyName = keepId_QueryDerivedReferrer_PersistentEventValueListParameter(value);
        registerQueryDerivedReferrer(function, cb.query(), "ID", "EVENT_ID",
                subQueryPropertyName, "persistentEventValueList", operand,
                value, parameterPropertyName, option);
    }

    public abstract String keepId_QueryDerivedReferrer_PersistentEventValueList(
            PersistentEventValueCQ subQuery);

    public abstract String keepId_QueryDerivedReferrer_PersistentEventValueListParameter(
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_Equal()</span>.max(new SubQuery&lt;PersistentEventCB&gt;() {
     *     public void query(PersistentEventCB subCB) {
     ...
     */
    public HpSSQFunction<PersistentEventCB> scalar_Equal() {
     ...
     * {where FOO &lt;&gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_NotEqual()</span>.max(new SubQuery&lt;PersistentEventCB&gt;() {
     *     public void query(PersistentEventCB subCB) {
     *         subCB.specify().setXxx... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setYyy...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<PersistentEventCB> scalar_NotEqual() {
     ...
     * {where FOO &gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_GreaterThan()</span>.max(new SubQuery&lt;PersistentEventCB&gt;() {
     *     public void query(PersistentEventCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<PersistentEventCB> scalar_GreaterThan() {
     ...
     * {where FOO &lt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_LessThan()</span>.max(new SubQuery&lt;PersistentEventCB&gt;() {
     *     public void query(PersistentEventCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<PersistentEventCB> scalar_LessThan() {
     ...
     * {where FOO &gt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_GreaterEqual()</span>.max(new SubQuery&lt;PersistentEventCB&gt;() {
     *     public void query(PersistentEventCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<PersistentEventCB> scalar_GreaterEqual() {
     ...
     * {where FOO &lt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_LessEqual()</span>.max(new SubQuery&lt;PersistentEventCB&gt;() {
     *     public void query(PersistentEventCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<PersistentEventCB> scalar_LessEqual() {
        return xcreateSSQFunction(CK_LE.getOperand());
    }

    protected HpSSQFunction<PersistentEventCB> xcreateSSQFunction(
            final String operand) {
        return new HpSSQFunction<PersistentEventCB>(
                new HpSSQSetupper<PersistentEventCB>() {
                    @Override
                    public void setup(final String function,
                            final SubQuery<PersistentEventCB> subQuery,
                            final HpSSQOption<PersistentEventCB> option) {
    ...
    protected void xscalarCondition(final String function,
            final SubQuery<PersistentEventCB> subQuery, final String operand,
            final HpSSQOption<PersistentEventCB> option) {
        assertObjectNotNull("subQuery<PersistentEventCB>", subQuery);
        final PersistentEventCB cb = xcreateScalarConditionCB();
        subQuery.query(cb);
    ...
    public abstract String keepScalarCondition(PersistentEventCQ subQuery);
    ...
    public void xsmyselfDerive(final String function,
            final SubQuery<PersistentEventCB> subQuery, final String aliasName,
            final DerivedReferrerOption option) {
        assertObjectNotNull("subQuery<PersistentEventCB>", subQuery);
        final PersistentEventCB cb = new PersistentEventCB();
        cb.xsetupForDerivedReferrer(this);
    ...
    public abstract String keepSpecifyMyselfDerived(PersistentEventCQ subQuery);
    ...
    protected HpQDRFunction<PersistentEventCB> xcreateQDRFunctionMyselfDerived() {
        return new HpQDRFunction<PersistentEventCB>(
                new HpQDRSetupper<PersistentEventCB>() {
                    @Override
                    public void setup(final String function,
                            final SubQuery<PersistentEventCB> subQuery,
                            final String operand, final Object value,
    ...
    public abstract String keepQueryMyselfDerived(PersistentEventCQ subQuery);
     ...
     */
    public void myselfExists(final SubQuery<PersistentEventCB> subQuery) {
        assertObjectNotNull("subQuery<PersistentEventCB>", subQuery);
        final PersistentEventCB cb = new PersistentEventCB();
    ...
    public abstract String keepMyselfExists(PersistentEventCQ subQuery);
     ...
     * @param subQuery The implementation of sub query. (NotNull)
     */
    public void myselfInScope(final SubQuery<PersistentEventCB> subQuery) {
        assertObjectNotNull("subQuery<PersistentEventCB>", subQuery);
        final PersistentEventCB cb = new PersistentEventCB();
    ...
    public abstract String keepMyselfInScope(PersistentEventCQ subQuery);
