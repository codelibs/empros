 ...
 */
@Configuration
@ComponentScan(value="org.codelibs.empros.db.exbhv", lazyInit=true)
public class DBFluteBeansJavaConfig {
    ...
    public DBFluteInitializer createDBFluteInitializer() { // no lazy for initialize-only component
        return new org.codelibs.empros.db.allcommon.DBFluteInitializer(_dataSource);
    }
    ...
    protected ImplementedInvokerAssistant newImplementedInvokerAssistant() {
        return new org.codelibs.empros.db.allcommon.ImplementedInvokerAssistant();
    }
